...
export default function CompanyTable() {
  ...
  return (
    <div className="card overflow-hidden p-0">
      ...
      <div className="grid grid-cols-[2fr_1fr_1fr_1fr_1fr_1fr_1fr_120px_40px] gap-2 px-5 py-3 bg-[#03440c] border-b border-[#0a5c14] text-[10px] font-medium text-white uppercase tracking-wider">
        <span>Company</span>
        <span>Status</span>

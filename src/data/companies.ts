...
const companies: Company[] = [
  ...
  },
  {
    ...
    stage: "Growth",
    status: "watch",
    description: "Develops and operates solar mini-grids serving rural communities and commercial clusters in Tanzania. Revenue from connection fees and per-kWh tariffs.",
  ...
  },
  {
    ...
    stage: "Scaling",
    status: "healthy",
    description: "Distributes solar home systems on a pay-as-you-go (PAYG) basis to off-grid households in Uganda. Revenue from daily mobile money micropayments over 24-month contracts.",
  ...
  // ─── AGRICULTURE (3) ────────────────────────────────────────
  {
    ...
    stage: "Growth",
    status: "watch",
    description: "Provides digital crop loans to smallholder farmers in Rwanda via mobile, using satellite imagery and farm-level data for credit scoring.",
  ...
  // ─── FINTECH (1) ────────────────────────────────────────────
  {
    ...
    stage: "Scaling",
    status: "healthy",
    description: "B2B payment processing platform for SMEs in Ghana, enabling cross-border payments and FX settlement across West Africa.",
